 ...
 * @method static \LSNepomuceno\Signet\Data\SignatureReport validate(string $pdfPath, ?\LSNepomuceno\Signet\Validation\TrustStore $trust = null)
 * @method static list<\LSNepomuceno\Signet\Data\SignatureField> signatureFields(string $pdfPath)
